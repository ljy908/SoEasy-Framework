...
echo "<td align = center>	<font color = white size = 5><b>Code List</b></font></td>";
echo "<tr><td align = center> <input type=button style=\"width:100%\" value='New File' onClick=newFile()></input> <br></tr>";
